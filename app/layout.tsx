  ...
  return (
    <html lang="en">
      <>
        <div className="">
          <div className="">
            <div id="thumbnail" className="bg-white">
              <div
                id="head"
              ...
              >
                <div id="navigationMenu" className="">
                  <ul className="flex flex-wrap items-center justify-center text-xl font-normal text-white gap-8 md:gap-12">
                    <li>
            ...
            <div className="max-w-[120rem] mx-auto mb-16">
              <div className="flex flex-col lg:flex-row px-4 md:px-14 gap-x-4 md:gap-x-16 relative bg-slate-50">
                ...
                <div className="flex flex-col lg:w-full">
                  <div
                    id="content"
                    className="flex-grow h-full overflow-scroll container-snap lg:mx-0 mx-8"
                  >
                    <div className="">
                      <div id="navigationMenu" className="">
                        <ul className="flex flex-wrap items-center justify-start 2xl:justify-around text-xl font-medium text-gray-500 dark:text-white gap-12 lg:gap-8 md:gap-12 lg:mt-12 w-max lg:w-full ">
                          <Link href="/" className="hover:underline">
                            <li className="flex items-center space-x-2 justify-center text-base border rounded-full px-8 py-2">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="30"
                                height="30"
                          ...
                          <a href="/myproject" className="hover:underline">
                            <li className="flex items-center space-x-2 justify-center text-base border rounded-full px-8 py-2">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
