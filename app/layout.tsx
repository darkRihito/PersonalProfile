        ...
        <div className="">
          ...
          <div className="max-w-[120rem] mx-auto mb-16">
            <div className="flex flex-col lg:flex-row px-4 md:px-14 gap-x-4 md:gap-x-16 relative bg-slate-50">
              <div
                id="aside"
                className="w-full lg:max-w-xs relative -top-16 bg-white rounded-lg py-4"
              >
                <div id="profile">
                  <div className="">
              ...
              <div id="content" className="flex-grow h-full overflow-scroll container-snap lg:mx-0 mx-8">
                <div className="">
                  <div id="navigationMenu" className="">
                    <ul className="flex flex-wrap items-center justify-around text-xl font-medium text-gray-500 dark:text-white gap-16 lg:gap-8 md:gap-12 lg:mt-12 w-max md:w-full ">
                  ...
                  <div className="border-4 mt-8 h-96">
                    {children}
                  </div>
                </div>
              </div>
